 ...
 */
public class Postres  extends AppCompatActivity implements Observer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Latte.setText("Cadena Split");
        Capuccino.setText("Milo");
        Expresso.setText("Maracuya");
        Leche.setText("Oreo");
        Mocca.setText("Guayaba");
    ...
    public void update(Observable observable, Object data) {
        ...
        a.setText(b);
        Intent intent = new Intent(Postres.this, Final.class);
